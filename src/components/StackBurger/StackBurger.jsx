  ...
  return (
    <div className="stack-container">
      ...
      <Parallax pages={2}>
        ...
        <ParallaxLayer offset={1.35} speed={1} id={'topbun'}><img src={topBun} alt="Burger bun top"/></ParallaxLayer>
        <ParallaxLayer offset={1.35} speed={2} id={'onions'}><img src={onions} alt="onions"/></ParallaxLayer>
        <ParallaxLayer offset={1.35}  speed={3} id={'tomatoes'}><img src={tomatoes} alt="tomatoes" id="tomatoes"/></ParallaxLayer>
        <ParallaxLayer offset={1.35}  speed={4} id={'patty'}><img src={patty} alt="patty" id="patty"/></ParallaxLayer>
        <ParallaxLayer offset={1.35} speed={5} id={'bottombun'}><img src={bottomBun} alt="Burger bun bottom" id="bottomBun"/></ParallaxLayer>
      </Parallax>
      </div>
    </div>
  )

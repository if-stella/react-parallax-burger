        ...
        <div className="bottom-ingredients">
          <div className="bi-box">
            <div className="bi-box-imgs">
              <img src={images[0]} alt="Raw patty" data-aos="fade-up-left" data-aos-duration="300" data-aos-easing="ease-in-out"/>
              <img src={images[1]} alt="Grilled patty" data-aos="fade-up-left" data-aos-duration="400" data-aos-easing="ease-in-out"/>
            </div>
            <Ingredientdetail ingredientName={ingredients[1]} ingredientInfo={infos[1]}/>
          </div>
          <div className="bi-box">
            <div className="bi-box-imgs">
              <img src={images[2]} alt="Bacon slice" data-aos="fade-up-right" data-aos-duration="300" data-aos-easing="ease-in-out"/>
              <img src={images[3]} alt="Bacon slice" data-aos="fade-up-right" data-aos-duration="400" data-aos-easing="ease-in-out"/>
            </div>
